...
/*   Updated: 2017/09/05 01:45:53 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_wall_col(t_env *e, int x)
{
	...
	p1.y = 0;
	p2.x = x;
//	e->r.dst *= fabsl(cosl((e->player.dir - e->r.rad) * DEG2RAD)); // euclidian lsd
	e->r.dst *= fabsl(cosl((e->player.dir - e->r.deg) * DEG2RAD));
